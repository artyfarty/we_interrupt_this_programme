<div class="box box-info padding-1">
    <div class="box-body">
        ...
        {{-- <div class="form-group">
            {{ Form::label('lines') }}
            {{ Form::text('lines', $notification->lines, ['class' => 'form-control' . ($errors->has('lines') ? ' is-invalid' : ''), 'placeholder' => 'Lines']) }}
            {!! $errors->first('lines', '<div class="invalid-feedback">:message</p>') !!}
        </div> --}}
        {{--<div class="form-group">
            {{ Form::label('meta') }}
            {{ Form::text('meta', $notification->meta, ['class' => 'form-control' . ($errors->has('meta') ? ' is-invalid' : ''), 'placeholder' => 'Meta']) }}
            {!! $errors->first('meta', '<div class="invalid-feedback">:message</p>') !!}
        </div>--}}
        <div class="form-group">
