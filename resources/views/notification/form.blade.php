<div class="box box-info padding-1">
    <div class="box-body">
        {{--<div class="form-group">
            ...
            {!! $errors->first('program_event_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            ...
            {!! $errors->first('donation_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>--}}
        <div class="row">
            <div class="col">
                <div class="form-group">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    {!! $errors->first('display_limit', '<div class="invalid-feedback">:message</div>') !!}
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    {!! $errors->first('display_from', '<div class="invalid-feedback">:message</div>') !!}
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    {!! $errors->first('display_till', '<div class="invalid-feedback">:message</div>') !!}
                </div>
            </div>
        </div>
